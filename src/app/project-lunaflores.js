        ...
        >
          ...
          <div>
            ...
            <p className="text-zinc-300 leading-relaxed text-lg">
              Backend desenvolvido utilizando Java e Spring Boot,
              focado em autenticação JWT, gerenciamento de produtos,
              usuários e estrutura REST API moderna.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-zinc-300 text-lg">
              ...
              <li>✔ Estrutura RESTful</li>
              <li>✔ Integração com banco MySQL</li>
